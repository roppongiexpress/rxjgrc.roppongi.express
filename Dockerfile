...
RUN cd /src/jgrc2023 && hugo --gc --minify --baseURL "https://rxjgrc.roppongi.express/" -d /build \
    && cd /src/jgrc2020 && hugo --gc --minify --baseURL "https://rxjgrc.roppongi.express/2020/" -d /build/2020
